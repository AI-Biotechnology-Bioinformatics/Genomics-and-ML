# AI & Biotechnology/Bioinformatics

# A Comprehensive Guide to Microarray Data Analysis in R
...
#### Step 2: Downloading Microarray Data from NCBI GEO ####

### How to Download the Data ?
# 1. Visit NCBI GEO(https://www.ncbi.nlm.nih.gov/geo/)
# 2. Search for "GSE79973"
# 3. Go to the **Supplementary Files** section and download "GSE79973_RAW.tar" file
# 4. Extract the files into a working directory

# Alternatively, Run this command to automate the download
...
#### Visualize Significant vs. Non-Significant DEGs ####
...
#### Visualize Up vs. down regulated DEGs ####
...
# To classify cancer and normal samples, 
# we use "Random Forest" Classifier with "Information Gain" based feature selection
...
#### Features Selection with Information Gain ####
